...
:: alone. That template defines the CLI contract the launcher calls it through.
::
...
:: --- CONFIG BLOCK ---
set "GAME_ID=kingdom-come-deliverance"
set "MOD_DISPLAY_NAME=Kingdom Come: Deliverance Head Tracking"
set "MOD_DLLS=KingdomComeDeliveranceHeadTracking.asi"
set "MOD_INTERNAL_NAME=KingdomComeDeliveranceHeadTracking"
set "MOD_VERSION=0.0.0"
set "STATE_FILE=.headtracking-state.json"
set "FRAMEWORK_TYPE=ASILoader"
set "ASI_LOADER_NAME=dinput8.dll"
set "MOD_CONTROLS=Controls: End = toggle tracking, Page Up = cycle mode (6DOF / rotation only / position only), Page Down = world/local yaw. Chords: Ctrl+Shift+Y / Ctrl+Shift+G / Ctrl+Shift+H."
...
:: See vendor/ultimate-asi-loader/README.md for the pinned upstream snapshot.
:: ============================================
:install_asi_loader
